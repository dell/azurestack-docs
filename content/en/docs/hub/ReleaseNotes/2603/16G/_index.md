---
title: "Release Notes for 16G - Dell 2603"
linkTitle: "16G"
weight: 7397
Description: >
...
### Current Release Version: Dell 2603 and Microsoft 2601
### Release Type: Major (MA)

{{% alert title="NOTE" color="primary" %}}
Dell Azure Stack Hub OEM updates must be installed in sequential order, it is not supported to skip or miss-out an OEM update version. These release notes contain supplemental information for the Dell 2603 release and the Microsoft 2601 release.
{{% /alert %}}

## New features, changed features, and fixes
### New features
There are improvements and updates to drivers and firmware. See [Release Artifacts for 16G - Dell 2603]({{< ref "../../../ReleaseArtifacts/2603/16G/_index.md" >}}).
...
This release notes document describes known issues and limitations for the Dell Integrated System for Microsoft Azure Stack Hub solution based on the Dell 2603 release and Microsoft 2601 release.
...
For information about supported hardware, firmware, and software, see the [Dell Integrated System for Microsoft Azure Stack Hub Support Matrix]({{< ref "../../../SupportMatrix/2603/16G/_index.md" >}}).
